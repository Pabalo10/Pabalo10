...
Soy estudiante de último año del **Grado en Ingeniería de Datos e Inteligencia Artificial** en la Universidad Complutense de Madrid (UCM). Me apasiona el diseño de arquitecturas de *Machine Learning*, el Procesamiento de Lenguaje Natural (PLN) y el análisis de datos masivos para resolver problemas complejos.

A nivel de gestión de equipos, he formado parte del equipo directivo del Colegio Mayor Mendel como Decano durante dos años. Cuando desconecto del código, me dedico a la música (producción y guitarra clásica/eléctrica) y a los deportes.

📫 **Contacto:** [www.linkedin.com/in/palonsor] | [pabalonsor@gmail.com]

---

## 🛠️ Stack Tecnológico

*   **Lenguajes:** Python, C/C++, SQL, JavaScript
*   **Data Science & ML:** Pandas, Scikit-Learn, PyTorch
*   **NLP & LLMs:** spaCy, Ollama, Llama, Qwen, Arquitecturas RAG
*   **Big Data & Cloud:** GCP, Dataproc, Cloud Run, Hadoop, Spark
*   **High Performance Computing (HPC):** OpenMP, CUDA, POSIX
...
A continuación destaco mis principales desarrollos, estructurados según mis áreas de especialización:

### 🏙️ Ingeniería de Datos y Big Data
...
*   **[Buscador Semántico "El Quijote"](https://github.com/Pabalo10/quijote-semantic-search)** (2025 - 2026)
    *   **Tecnologías:** spaCy, TF-IDF, Embeddings.
    *   **Descripción:** Motor de búsqueda inteligente sobre texto clásico combinando recuperación léxica clásica y embeddings semánticos.
